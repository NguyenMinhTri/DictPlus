 ...
 */
public class FragmentAllHistory  extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
        ...
        query.findInBackground(new FindCallback<History>() {
            ...
            public void done(List<History> tasks, ParseException error) {
                if (error == null) {
                    ...
                    mAdapter = new HistoryAdapter(getActivity(), tempHistory, mTouchListener, false);
    ...
    public void onCreate(Bundle savedInstanceState) {
      /*  String html="";
        int pos1=html.indexOf("class=\"tar vdt\"");
        int pos2=html.indexOf("class='fb'");
                                ...
                                withEndAction(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if ("a"=="c" ) {
                                            ...
                                            Toast.makeText(getActivity(), "Không được xóa", Toast.LENGTH_SHORT).show();
                                            mSwiping = false;
    ...
    private void animateRemoval(final ListView listview, View viewToRemove) {
        ...
        try {
            ...
            mAdapter.getItem(position).saveEventually();
